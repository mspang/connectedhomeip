...
#ifndef CONFIG_CHIP_ENABLE_CHIPOBLE_ADVERTISING_AUTOSTART
#define CHIP_DEVICE_CONFIG_CHIPOBLE_ENABLE_ADVERTISING_AUTOSTART 0
#else
#define CHIP_DEVICE_CONFIG_CHIPOBLE_ENABLE_ADVERTISING_AUTOSTART CONFIG_CHIP_ENABLE_CHIPOBLE_ADVERTISING_AUTOSTART
#endif // CONFIG_CHIP_ENABLE_CHIPOBLE_ADVERTISING_AUTOSTART
